...
The specific process for the access token will be implemented per use case delivery and so please review the guidance in the specific standard for your use case.  For example review the guidance in the UEC Appointment Bookings standard if implementing UEC appointment bookings.
