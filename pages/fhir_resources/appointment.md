...
| description | [1..1] | Text describing the need for the appointment, to be shown for example in an appointment list. Note that developers should follow appropriate guidance for their use case as to appropriate content in this field. | 111 Referral |
